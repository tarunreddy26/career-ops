...
const OUT = "/home/user/career-ops/TNASICON2026-Poster-v2-Metastatic-Ileal-Perforation.pptx";
...
const FS = { title: 50, sub: 31, present: 27, guide: 23, inst: 21,
             sec: 29, body: 35, cap: 20, foot: 20, stat: 40, statL: 20, ref: 17,
             callT: 29, callB: 34 };
...
const MIN_DPI = 140;   // print-quality floor for large-format printing
const IMG = {
  breast:  { p: DIR + "v2-1-breast-clinical.png",        px: 793,  py: 845 },
  xray:    { p: DIR + "v2-2-xray-pneumoperitoneum.jpeg", px: 546,  py: 630 },
  ct:      { p: DIR + "v2-3-ct-abdomen.jpeg",            px: 916,  py: 754 },
...
for (const k in IMG) {
  ...
  i.dpiMaxW = i.px / MIN_DPI;        // widest we may print it
  i.dpiMaxH = i.py / MIN_DPI;
}
...
function bulletRuns(items, fs, color) {
  return items.map(it => {
    ...
    return { text: o ? it.t : it, options: {
      ...
      bold: !!(o && it.b), bullet: { code: "2022", indent: 20 },
...
const T = {
  ...
  caseRep: [
    ...
    "History of chronic NSAID abuse for pain related to a right breast lump, which had been misdiagnosed as a breast abscess.",
  ],
  clinical: [
  ...
  investig: [
    ...
    "Contrast-enhanced CT of the abdomen (Fig 3).",
  ],
  operative: [
  ...
  histo: [
    ...
    { t: "Ileal biopsy: metastatic deposits at the perforation site (Fig 6).", b: true, c: NAVY },
    "Breast origin of intestinal metastases is confirmed on immunohistochemistry — GATA3 (most sensitive), GCDFP-15, mammaglobin and ER; E-cadherin positivity supports ductal type. [5]",
  ],
  discussion: [
  ...
  keymsg: [
    ...
    "Always biopsy the perforation margin.",
  ],
  refs: [
...
const col2 = [
  ...
  imgPair(c2W, "xray", "ct", "Fig 2.", "Erect abdominal radiograph — pneumoperitoneum.", "Fig 3.", "Contrast-enhanced CT of the abdomen."),
...
const col3 = [
  ...
  callout("Differential Diagnosis", T.differential, c3W, { fill: BLUETINT, line: BLUE, tcol: NAVY, bcol: "24384F" }),
